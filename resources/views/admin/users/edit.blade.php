            ...
            <form method="POST" class="space-y-4" action="{{ route('users.update', $user) }}">
                ...
                <div>
                    ...
                    <x-text-input id="date_of_birth" class="block mt-1 w-full" type="date" name="date_of_birth"
                        :value="$user->date_of_birth" autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="street" class="block mt-1 w-full" type="text" name="street"
                        :value="$user->street" autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="house_number" class="block mt-1 w-full" type="text" name="house_number"
                        :value="$user->name" autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="zip_code" class="block mt-1 w-full" type="text" name="zip_code"
                        :value="$user->zip_code" autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="city" class="block mt-1 w-full" type="text" name="city"
                        :value="$user->city" autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <x-text-input id="country" class="block mt-1 w-full" type="text" name="country"
                        :value="$user->country" autofocus autocomplete="username" />
